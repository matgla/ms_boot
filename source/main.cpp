...
//    board::gpio::LED().init(hal::gpio::Output::OpenDrain, hal::gpio::Speed::Default, hal::gpio::PullUpPullDown::None);
    ...
    connection.on_boot([]{
        ...
        printer << "Booting from: 0x" << msboot::hex << board::FlashParameters::app_start << msboot::endl; 
        std::uintptr_t* firmware = reinterpret_cast<std::uintptr_t*>(board::FlashParameters::app_start);
